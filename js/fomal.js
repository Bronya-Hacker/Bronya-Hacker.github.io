...
function createtime() {
  ...
  let currentTimeHtml = "";
  (currentTimeHtml =`<div style="font-size:13px;font-weight:bold">本站运行 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 </div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(assets\bg.png);
    --darkmode-bg:url(assets\bg.png);
    --mobileday-bg: url(assets\bg.png);
    --mobilenight-bg: url(assets\bg.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
